...
public abstract class Command {
	  ...
	  /**
		 ...
		 */
	  public abstract boolean execute(GameModel game) throws CommandExecuteException, InitializationException;
	  
	  public abstract Command parse(String[] commandWords) throws CommandParseException, InitializationException;
